...
class LightState:
    ...
    label: str
    power: str  # "on" or "off"
    color: Dict[str, Any]  # hue, saturation, kelvin
...
class LIFXService:
    ...
    def _request(self, method: str, endpoint: str, **kwargs) -> Dict[str, Any]:
        """Make API request with error handling and default timeout."""
        if not self.enabled:
            return {}
        url = f"{self.BASE_URL}{endpoint}"
        try:
            # Pop timeout to avoid duplicate argument in requests.request
            ...
            print(f"[!] LIFX API error: {req_err}")
    ...
    def get_light_names(self) -> List[str]:
        ...
        all_lights = self.list_lights()
        return [light.label for light in all_lights]

    def validate_color(self, color_string: str) -> Dict[str, Any]:
    ...
    def toggle(self, selector: str = "all", duration: float = 1.0) -> Dict[str, Any]:
        """Toggle power state."""
        return self._request("POST", f"/lights/{selector}/toggle", json={
            "duration": duration
        })

    def turn_on(self, selector: str = "all", duration: float = 1.0) -> Dict[str, Any]:
        """Turn lights on."""
        return self.set_power(selector, "on", duration)

    def turn_off(self, selector: str = "all", duration: float = 1.0) -> Dict[str, Any]:
        """Turn lights off."""
    ...
    def set_color(self,
                  ...
                  duration: float = 1.0) -> Dict[str, Any]:
        """Set light color."""
        return self.set_state(selector, power="on", color=color,
    ...
    def dim(self, selector: str = "all", percent: int = 50,
            duration: float = 1.0) -> Dict[str, Any]:
    ...
    def set_states(self,
        ...
        for fx_cmd in fx_commands:
            self.run_fx(fx_cmd["selector"], fx_cmd["fx"])

        return result

    def run_fx(self, selector: str, fx_name: str) -> Dict[str, Any]:
        """Run a named effect on a device."""
        fx_lower = fx_name.lower().replace(" ", "_")

        fx_map = {
            "color_cycle": lambda: self.breathe(selector, "rainbow", period=5,
                                                cycles=100, persist=True),
            ...
            "twinkle": lambda: self.breathe(selector, "white", period=0.5,
                                            cycles=100, persist=True),
            "flicker": lambda: self.breathe(selector, "orange", period=0.3,
                                            cycles=100, persist=True),
            "meteor": lambda: self.move(selector, direction="forward",
                                        period=0.5, cycles=20),
            "pastels": lambda: self.morph(selector, palette=["pink", "lavender",
                                                               "mint", "peach"]),
            "random": lambda: self.morph(selector),
            "spooky": lambda: self.breathe(selector, "purple", period=4,
                                           cycles=50, persist=True),
    ...
    def breathe(self,
                ...
                cycles: float = 3,
                persist: bool = False,
                peak: float = 0.5) -> Dict[str, Any]:
        """
        Pulsing breathe effect.
        peak: 0.0 to 1.0 (0.5 = smooth sine)
        """
    ...
    def pulse(self,
              ...
              cycles: float = 3,
              persist: bool = False,
              power_on: bool = True) -> Dict[str, Any]:
        """Flash pulse effect."""
        payload = {
            "color": color,
            "period": period,
    ...
    def effects_off(self, selector: str = "all") -> Dict[str, Any]:
        """Stop all effects."""
    ...
    def brighter(self, selector: str = "all", amount: float = 0.1,
                 duration: float = 0.5) -> Dict[str, Any]:
        """Make lights brighter."""
        return self.state_delta(selector, brightness=amount, duration=duration)

    def dimmer(self, selector: str = "all", amount: float = 0.1,
               duration: float = 0.5) -> Dict[str, Any]:
        """Make lights dimmer."""
        return self.state_delta(selector, brightness=-amount, duration=duration)

    def warmer(self, selector: str = "all", amount: int = 500,
               duration: float = 0.5) -> Dict[str, Any]:
        """Make lights warmer."""
        return self.state_delta(selector, kelvin=-amount, duration=duration)

    def cooler(self, selector: str = "all", amount: int = 500,
               duration: float = 0.5) -> Dict[str, Any]:
        """Make lights cooler."""
        return self.state_delta(selector, kelvin=amount, duration=duration)
    ...
    def morph(self,
              selector: str = "all",
              period: float = 5.0,
              palette: Optional[List[str]] = None) -> Dict[str, Any]:
    ...
    def sunrise(self, selector: str = "all", duration: float = 300.0) -> Dict[str, Any]:
        """Sunrise effect."""
    ...
    def sunset(self, selector: str = "all", duration: float = 300.0) -> Dict[str, Any]:
        """Sunset effect."""
    ...
    def activate_scene(self, scene_uuid: str, duration: float = 1.0) -> Dict[str, Any]:
        """Activate a saved scene by UUID."""
        return self._request("PUT", f"/scenes/scene_id:{scene_uuid}/activate", json={
            "duration": duration
        })

    def activate_scene_by_name(self, name: str, duration: float = 1.0) -> Dict[str, Any]:
    ...
    def movie_mode(self, selector: str = "all") -> Dict[str, Any]:
        """Movie mode."""
        return self.set_state(selector, power="on", color="kelvin:2200",
                              brightness=0.15, duration=2)

    def focus_mode(self, selector: str = "all") -> Dict[str, Any]:
        """Focus mode."""
        return self.set_state(selector, power="on", color="kelvin:4000", brightness=0.8, duration=1)

    def relax_mode(self, selector: str = "all") -> Dict[str, Any]:
        """Relax mode."""
        return self.set_state(selector, power="on", color="kelvin:2700", brightness=0.5, duration=2)

    def party_mode(self, selector: str = "all") -> Dict[str, Any]:
        """Party mode."""
    ...
    def alert(self, selector: str = "all", color: str = "red") -> Dict[str, Any]:
        """Alert pulse."""
    ...
    def bedroom(self, **kwargs) -> Dict[str, Any]:
        """Bedroom selector."""
        return self.set_state(self.BEDROOM, **kwargs)

    def living_room(self, **kwargs) -> Dict[str, Any]:
        """Living room selector."""
    ...
    def photo_mode(self, selector: str = "all") -> Dict[str, Any]:
        """Photo mode."""
        return self.set_state(selector, power="on", color="kelvin:5000",
                              brightness=1.0, duration=1)

    def chill_mode(self, selector: str = "all") -> Dict[str, Any]:
        """Chill mode."""
        return self.set_state(selector, power="on", color="kelvin:2400",
                              brightness=0.35, duration=2)

    def work_mode(self, selector: str = "all") -> Dict[str, Any]:
        """Work mode."""
        return self.set_state(selector, power="on", color="kelvin:4500", brightness=0.9, duration=1)

    def christmas_mode(self, selector: str = "all") -> Dict[str, Any]:
        """Christmas mode."""
    ...
    def warm_ember(self, selector: str = "all") -> Dict[str, Any]:
        """Warm ember."""
