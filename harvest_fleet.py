...
print(f"Starting Fleet Harvest for 2026 (Jan 1 - Present)...")
...
# Sort chronologically (reverse for latest first in changelog usually, but let's stick to chrono for now)
timeline.sort(key=lambda x: x['date'], reverse=True) # Newest first for 2026
