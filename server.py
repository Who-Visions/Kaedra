...
app = FastAPI(title="Kaedra Agent API", version="4.2", description="Fleet-compatible API for Kaedra Orchestrator")
...
async def notion_webhook(request: Request):
    ...
    if "verification_token" in body:
        print(f"[Notion Webhook] Verification request received")
    ...
    # TODO: Process events (page.updated, database.updated, comment.created, etc.)
